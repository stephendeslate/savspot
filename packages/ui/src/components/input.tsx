  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-[var(--glow-primary)]",
        "aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40",
        {
          "h-8 py-1 text-sm": inputSize === "sm",
          "h-10 py-2": inputSize === "md",
          "h-12 py-3 text-base md:text-base": inputSize === "lg",
        },
        className
      )}
      {...props}
