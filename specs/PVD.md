...
- **Phase 1 is web-only:** The native mobile app is deferred to Phase 3 (see PRD §4.5) to tighten Phase 1 scope and maximize development focus on the core booking platform. Mobile-responsive web covers client booking needs during initial validation. The mobile app ships in Phase 3 alongside the MCP server, AI Voice Receptionist, and workflow automation — features that benefit more from native capabilities.
