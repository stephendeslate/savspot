...
// Tenant memberships
export const MEMBERSHIP_A_OWNER_ID = '00000000-0000-4000-c000-000000000001';
export const MEMBERSHIP_A_STAFF_ID = '00000000-0000-4000-c000-000000000002';
export const MEMBERSHIP_B_OWNER_ID = '00000000-0000-4000-c000-000000000003';
export const MEMBERSHIP_B_STAFF_ID = '00000000-0000-4000-c000-000000000004';
export const MEMBERSHIP_C_OWNER_ID = '00000000-0000-4000-c000-000000000005';

// Services — Tenant A (Barbershop)
export const SERVICE_A_HAIRCUT_ID = '00000000-0000-4000-d000-000000000001';
export const SERVICE_A_BEARD_ID = '00000000-0000-4000-d000-000000000002';
export const SERVICE_A_GROOMING_ID = '00000000-0000-4000-d000-000000000003';

// Services — Tenant B (Gym)
export const SERVICE_B_PT_ID = '00000000-0000-4000-d000-000000000004';
export const SERVICE_B_GROUP_ID = '00000000-0000-4000-d000-000000000005';

// Services — Tenant C (Venue)
export const SERVICE_C_RENTAL_ID = '00000000-0000-4000-d000-000000000006';

// Bookings — Tenant A
export const BOOKING_A1_ID = '00000000-0000-4000-e000-000000000001';
export const BOOKING_A2_ID = '00000000-0000-4000-e000-000000000002';
export const BOOKING_A3_ID = '00000000-0000-4000-e000-000000000003';
export const BOOKING_A4_ID = '00000000-0000-4000-e000-000000000004';
export const BOOKING_A5_ID = '00000000-0000-4000-e000-000000000005';

// Bookings — Tenant B
export const BOOKING_B1_ID = '00000000-0000-4000-e000-000000000006';
export const BOOKING_B2_ID = '00000000-0000-4000-e000-000000000007';
export const BOOKING_B3_ID = '00000000-0000-4000-e000-000000000008';

// Bookings — Tenant C
export const BOOKING_C1_ID = '00000000-0000-4000-e000-000000000009';
export const BOOKING_C2_ID = '00000000-0000-4000-e000-000000000010';
