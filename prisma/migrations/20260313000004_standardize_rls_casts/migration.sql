-- Standardize all RLS policies to use ::text cast for current_setting
-- This ensures consistent behavior across all tenant-scoped tables.
-- current_setting() returns text, so casting tenant_id to text is the
-- safest approach regardless of column type (uuid or text).

-- ============================================================================
-- Original RLS tables (from 20260303041239_rls_and_search)
-- ============================================================================
...
-- ============================================================================
-- Phase 4 RLS tables (from 20260311000000_add_phase4_rls_and_cascades)
-- ============================================================================
